...
public class GetDisputeDashboardQueryHandler 
    : IRequestHandler<GetDisputeDashboardQuery, ApiResponse<DisputeDashboardDto>>
{
    ...
    public async Task<ApiResponse<DisputeDashboardDto>> Handle(
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            // Final Response
            // =============================
            var dashboard = new DisputeDashboardDto
            {
            ...
            return ApiResponse<DisputeDashboardDto>.Success(
                dashboard,
        ...
        catch (Exception ex)
        {
            ...
            return ApiResponse<DisputeDashboardDto>.Failure(ex.Message);
        }
    }
}
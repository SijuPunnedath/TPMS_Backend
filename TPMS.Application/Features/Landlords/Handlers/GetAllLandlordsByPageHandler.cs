...
{
    public class GetAllLandlordsByPageHandler : IRequestHandler<GetAllLandlordsByPageQuery, PagedResult<LandlordDto>>
    {
        private readonly TPMSDBContext _db;

        public GetAllLandlordsByPageHandler(TPMSDBContext db) => _db = db;

        public async Task<PagedResult<LandlordDto>> Handle(GetAllLandlordsByPageQuery request, CancellationToken cancellationToken)
        {

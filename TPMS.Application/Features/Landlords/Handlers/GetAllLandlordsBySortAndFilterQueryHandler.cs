...
{
    public class GetAllLandlordsBySortAndFilterQueryHandler : IRequestHandler<GetAllLandlordsBySortAndFilterQuery, PagedResult<LandlordDto>>
    {
        private readonly TPMSDBContext _db;

        public GetAllLandlordsBySortAndFilterQueryHandler(TPMSDBContext db) => _db = db;

        public async Task<PagedResult<LandlordDto>> Handle(GetAllLandlordsBySortAndFilterQuery request, CancellationToken cancellationToken)
        {
            ...
            query = request.SortBy?.ToLower() switch
            {
                ...
                _ => query.OrderBy(l => l.LandlordID) // default sort
            };

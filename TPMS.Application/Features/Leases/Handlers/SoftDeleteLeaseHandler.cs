...
{
    public class SoftDeleteLeaseHandler : IRequestHandler<SoftDeleteLeaseCommand, bool>
    {
        private readonly TPMSDBContext _db;
        public SoftDeleteLeaseHandler(TPMSDBContext db) => _db = db;

        public async Task<bool> Handle(SoftDeleteLeaseCommand request, CancellationToken cancellationToken)
        {
